...
| `manage-agent-design.txt` | Agent-consumability output design (Shapes 4/6), the four agent-team topologies (Shape 7) | Output is consumed by another agent, or drafting an agent team |
